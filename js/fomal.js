...
function createtime1() {
  ...
  var ascll = [
    ...
    `
                              __                                   
                      /\ \                                  
 __  _  __  __   ____ \ \ \___      __      ___      __     
/\ \/'\/\ \/\ \ /\_ ,`\\ \  _ `\  /'__`\  /' _ `\  /'_ `\   
\/>  </\ \ \_/ |\/_/  /_\ \ \ \ \/\ \L\.\_/\ \/\ \/\ \L\ \  
 /\_/\_\\ \___/   /\____\\ \_\ \_\ \__/.\_\ \_\ \_\ \____ \ 
 \//\/_/ \/__/    \/____/ \/_/\/_/\/__/\/_/\/_/\/_/\/___L\ \
                                                     /\____/
                                                     \_/__/                                       
`,
    "小站已经苟活",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| xvzhang🥝") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('xvzhang🥝的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  var start = new Date("01/05/2025 00:00:00"); // 旅行者1号开始计算的时间
  var dis = Math.trunc(23400000000 + ((now - start) / 1000) * 17); // 距离=秒数*速度 记住转换毫秒
  var unit = (dis / 149600000).toFixed(6);  // 天文单位
  // 网站诞生时间
  var grt = new Date("01/03/2025 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://cdn.jsdelivr.net/gh/xvzhnang/blog-picture@main/img/X小屋-科研摸鱼中.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://cdn.jsdelivr.net/gh/xvzhnang/blog-picture@main/img/X小屋-下班休息啦.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
// picsum随机
let picsum = "url(https://cdn.jsdelivr.net/gh/xvzhnang/blog-picture@main/img/1080.webp)";
// 小歪二次元
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/xvzhnang/blog-picture@main/img/home_bg.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/xvzhnang/blog-picture@main/img/home_bg.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/xvzhnang/blog-picture@main/img/fj1.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/xvzhnang/blog-picture@main/img/fj1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/xvzhnang/blog-picture@main/img/mc1.webp)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/xvzhnang/blog-picture@main/img/mc1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/xvzhnang/blog-picture@main/img/mb4.webp)" class="pimgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/xvzhnang/blog-picture@main/img/mb4.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 设置自定义背景 </summary>
              <div class='content'>
              <p><center><input type="text" id="pic-link" size="70%" maxlength="1000" placeholder="https://cdn.jsdelivr.net/gh/xvzhnang/blog-picture@main/img/home_bg.webp"></center></p><p><center><button type="button" onclick="getPicture()" style="background:var(--theme-color);width:35%;padding: 5px 0px 7px 0px;border-radius:30px;color:white;line-height:2;">🌈切换背景🌈</button></center></p>
              </div>
            </details>
